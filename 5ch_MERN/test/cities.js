...
describe('*********** CITIES ***********', () => {
  ...
  describe('/POST genre', () => {
    it('it should NOT POST a genre without name', (done) => {
      const genre = {}
      chai
        .request(server)
        .post('/cities')
    ...
    it('it should NOT POST a genre that already exists', (done) => {
      const genre = {
        name
      }
      chai
  ...
  describe('/GET/:id genre', () => {
    it('it should GET a genre by the given id', (done) => {
  ...
  describe('/PATCH/:id genre', () => {
    ...
    it('it should NOT UPDATE a genre that already exists', (done) => {
      const genre = {
        name: repeatedName
      }
      chai
